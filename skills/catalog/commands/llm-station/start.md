...
2. If NOT running, start it in the background:
   ```
   ANTHROPIC_API_KEY=$ANTHROPIC_API_KEY /Users/bengamble/llm-station/build/llm-station start --workspace /Users/bengamble/llm-station --verbose 2>&1 &
   ```
   Then wait 3 seconds and verify it started:
   ```
   sleep 3 && /Users/bengamble/llm-station/build/llm-station status --workspace /Users/bengamble/llm-station 2>&1
   ```

3. Report back: is the daemon running, what tools are registered, and what model/provider is active. Use:
   ```
   /Users/bengamble/llm-station/build/llm-station --list-tools --workspace /Users/bengamble/llm-station 2>&1 | head -40
   ```

The daemon binary is at `/Users/bengamble/llm-station/build/llm-station`.
