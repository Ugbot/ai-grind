...
Consult this at the **start of every task**. It maps the work in front of you to
the right skill so you don't improvise what a skill already encodes.
...
Skills may ship **low** and **high** power variants. The active mode is stated in
the index header. Low favors speed and fewer steps; high favors thoroughness
(written plans, verification, subagents). Flip it with `skill_live action="mode"`
or the dashboard `GET /skills` panel.
