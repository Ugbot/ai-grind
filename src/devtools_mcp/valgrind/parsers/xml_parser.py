...
def parse_memcheck_xml(xml_path: str, run_base: RunBase) -> MemcheckResult:
...
def parse_threadcheck_xml(xml_path: str, run_base: RunBase, tool: str = "helgrind") -> ThreadCheckResult:
